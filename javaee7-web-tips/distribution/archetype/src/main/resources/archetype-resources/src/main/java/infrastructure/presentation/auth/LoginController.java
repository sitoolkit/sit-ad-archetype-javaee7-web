...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.infrastructure.presentation.auth;
...
import ${package}.infrastructure.Controller;
import ${package}.infrastructure.presentation.jsf.JSFUtils;
...
public class LoginController {
     ...
     * @see HttpServletRequest${symbol_pound}login
     */
    public String login() {
        try {
     ...
     *
     * @return 空文字
     * @see JSFUtils${symbol_pound}redirectHome()
     */
    public void logout() {
        try {
            request.logout();
