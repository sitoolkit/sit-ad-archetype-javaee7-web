...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.infrastructure.presentation.jsf;
...
public class JSFUtils {
     ...
     * @see FacesContext${symbol_pound}getCurrentInstance()
     ...
     *            リダイレクト先のURL
     * @return 空文字
     * @see ExternalContext${symbol_pound}redirect(java.lang.String)
     */
     ...
     * 
     * @return 空文字
     * @see ${symbol_pound}redirectUrl(java.lang.String)
     */
